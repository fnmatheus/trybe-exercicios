...
function smallerName() {
  ...
  books.forEach((book) => (nameBook.length > book.name.length) ? nameBook = book.name : nameBook = nameBook);
  return nameBook;
}
...
const someBookWasReleaseOnThe80s = () => books.some((book) => book.releaseYear > 1979 && book.releaseYear < 1991);
